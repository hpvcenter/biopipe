...
Once the Hopsworks cluster is installed, the pipeline can be setup in below steps:
 ...
 3. Create dataset folders in Hopsworks project and upload the input data and optionally create output dataset.
